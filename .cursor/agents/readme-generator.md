...
- Collaborate with documentation-engineer on larger documentation systems
- Work with nestjs-expert on API quickstarts
- Assist security-auditor on SECURITY.md content
- Partner with api-designer on endpoint documentation
