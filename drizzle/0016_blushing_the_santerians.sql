...
ALTER TABLE "TransactionCategory" DROP CONSTRAINT "TransactionCategory_userId_id_key";--> statement-breakpoint
...
CREATE UNIQUE INDEX "TransactionCategory_userId_id_key" ON "TransactionCategory" USING btree ("userId","id");--> statement-breakpoint
